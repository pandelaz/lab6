package com.example.hongyi.lab6;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter transAdapter = new myAdapter(transData,R.layout.activity_main3);
        ...
        myAdapter cubeeAdapter = new myAdapter(cubeeData,R.layout.activity_main2);
